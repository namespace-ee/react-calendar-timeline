...
var TimelineMarkersRenderer = function TimelineMarkersRenderer() {
  return /*#__PURE__*/_react["default"].createElement(_TimelineStateContext.TimelineStateConsumer, null, function (_ref) {
    ...
    return /*#__PURE__*/_react["default"].createElement(_TimelineMarkersContext.TimelineMarkersConsumer, null, function (_ref2) {
      ...
      return markers.map(function (marker) {
        switch (marker.type) {
          case _markerType.TimelineMarkerType.Today:
            ...
            return /*#__PURE__*/_react["default"].createElement(_TodayMarker["default"], {
              key: marker.id,
          ...
          case _markerType.TimelineMarkerType.Custom:
            ...
            return /*#__PURE__*/_react["default"].createElement(_CustomMarker["default"], {
              key: marker.id,
              renderer: marker.renderer,
              date: marker.date,
              getLeftOffsetFromDate: getLeftOffsetFromDate
          ...
          case _markerType.TimelineMarkerType.Cursor:
            return /*#__PURE__*/_react["default"].createElement(_CursorMarker["default"], {
              key: marker.id,
              renderer: marker.renderer,
              getLeftOffsetFromDate: getLeftOffsetFromDate
            });
...
var _default = exports["default"] = TimelineMarkersRenderer;