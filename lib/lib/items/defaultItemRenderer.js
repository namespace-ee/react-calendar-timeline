...
var defaultItemRenderer = function defaultItemRenderer(_ref) {
  ...
  return /*#__PURE__*/_react["default"].createElement("div", getItemProps(item.itemProps), itemContext.useResizeHandle ? /*#__PURE__*/_react["default"].createElement("div", leftResizeProps) : '', /*#__PURE__*/_react["default"].createElement("div", {
    className: "rct-item-content",
    style: {
      maxHeight: "".concat(itemContext.dimensions.height)
    }
  }, itemContext.title), itemContext.useResizeHandle ? /*#__PURE__*/_react["default"].createElement("div", rightResizeProps) : '');
