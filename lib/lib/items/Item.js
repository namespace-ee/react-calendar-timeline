    ...
    value: function mountInteract() {
      ...
      (0, _interactjs2.default)(this.item).resizable({
        ...
        ondragenter: function ondragenter(event) {
          _this2.props.onPointEnter(event, _this2.itemId, Number(event.relatedTarget.id));
        },
        ondrop: function ondrop(event) {
          _this2.props.onPointDrop(event, _this2.itemId, Number(event.relatedTarget.id));
        },
        ondragleave: function ondragleave(event) {
          _this2.props.onPointLeave(event, _this2.itemId, Number(event.relatedTarget.id));
        }
      }).draggable({
