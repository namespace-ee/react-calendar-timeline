...
var ReactCalendarTimeline = function (_Component) {
  ...
  _createClass(ReactCalendarTimeline, [{
    ...
    value: function getDerivedStateFromProps(nextProps, prevState) {
      ...
      var derivedState = { items: items, groups: groups, sidebarWidth: sidebarWidth

        // console.log(sidebarWidth,prevState.sidebarWidth)
        // if the items or groups have changed we must re-render
      };var forceUpdate = items !== prevState.items || groups !== prevState.groups || sidebarWidth !== prevState.sidebarWidth;
