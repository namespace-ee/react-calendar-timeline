...
var PreventClickOnDrag = function (_Component) {
  ...
  function PreventClickOnDrag() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = PreventClickOnDrag.__proto__ || Object.getPrototypeOf(PreventClickOnDrag)).call.apply(_ref, [this].concat(args))), _this), _this.handleMouseDown = function (evt) {
...
exports.default = PreventClickOnDrag;