...
describe('TimelineHeaders', () => {
  it('Given TimelineHeaders When pass a left and right sidebars as children Then it should render a left and right sidebars', () => {
  ...
  it('Given TimelineHeaders When pass calendarHeaderStyle with overridden (overflow, width) Then it should not override the default values', () => {
    const { getByTestId } = renderTimelineWithLeftAndRightSidebar({
  ...
  it('Given TimelineHeaders When pass calendarHeaderStyle Then it be added to styles', () => {
    const { getByTestId } = renderTimelineWithLeftAndRightSidebar({
  ...
  it('Given TimelineHeaders When pass style with overridden (display, width) Then it should not override the default values', () => {
    const { getByTestId } = renderTimelineWithLeftAndRightSidebar({
  ...
  it('Given TimelineHeaders When pass style Then it should it be added to root`s styles', () => {
    const { getByTestId } = renderTimelineWithLeftAndRightSidebar({
  ...
  it('Given TimelineHeaders When pass calendarHeaderClassName Then it should be applied to the date header container', () => {
    const { getByTestId } = renderTimelineWithLeftAndRightSidebar({
  ...
  it('Given TimelineHeaders When no calendarHeaderClassName specified Then undefined should not be applied to the date header container', () => {
    const { getByTestId } = renderTimelineWithLeftAndRightSidebar({
  ...
  it('Given TimelineHeaders When pass className Then it should be applied to the root header container', () => {
    const { getByTestId } = renderTimelineWithLeftAndRightSidebar({
  ...
  it('Given TimelineHeaders When no className specified Then undefined should not be applied to the root header container', () => {
    const { getByTestId } = renderTimelineWithLeftAndRightSidebar({
      className: undefined
    })
  ...
  it('Given TimelineHeaders When rendered Then it should render the default styles of the date header container', () => {
    const { getByTestId } = renderTimelineWithLeftAndRightSidebar()
    const headerContainer = getByTestId('headerContainer')
  ...
  it('Given TimelineHeaders When rendered Then it should render the default styles of the rootStyle', () => {
    const { getByTestId } = renderTimelineWithLeftAndRightSidebar()
    const rootDiv = getByTestId('headerRootDiv')
    const { width, display } = getComputedStyle(rootDiv)
   ...
   */
  it('Given TimelineHeaders When pass a headers as children Then it should render them correctly', () => {
