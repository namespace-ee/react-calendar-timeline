...
const dimensionItems = [
  {
    id: 1,
    dimensions: {
      left: 100, top: 0, width: 200, height: 30,
      collisionLeft: 100, collisionWidth: 200,
      isDragging: false, originalLeft: 100, stack: true,
  ...
  },
  {
    id: 2,
    dimensions: {
      left: 300, top: 0, width: 200, height: 30,
      collisionLeft: 300, collisionWidth: 200,
      isDragging: false, originalLeft: 300, stack: true,
  ...
  it('filters items outside canvas time range', () => {
    ...
    const { container } = renderItems({
      ...
      dimensionItems: [{
        id: 3,
        dimensions: {
          left: 500, top: 0, width: 200, height: 30,
          collisionLeft: 500, collisionWidth: 200,
          isDragging: false, originalLeft: 500, stack: true,
          order: { index: 0, group: groups[0] },
        },
      }],
    })
